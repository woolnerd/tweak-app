...
// const fixtureMap = compositeFixturesStore.reduce((acc: FixtureMap, fixture) => {
//   acc[fixture.channel] = {
...
//       manufacturerSelection,
//     ),
//     fixtureName: handleFieldSelectionName(channel, fixtures, fixtureSelection),
//     profileName: handleFieldSelectionName(channel, profiles, profileSelection),
//   };
// }
