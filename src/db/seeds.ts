...
const patch ={fixtureId: 1, profileId: 1, startAddress: 81, endAddress: 90, showId: 1, }
const profile = { channelCount: 4, channels: JSON.stringify({ 1: 'Red', 2: 'Green', 3: 'Blue', 4: 'Intensity' }), name: 'mode 6' }
import {
  InsertFixture,
  InsertManufacturer,
  InsertProfile,
...
export const seeds: Seeds = {
  ...
  manufacturers: [
    ...
    { name: 'Aputure', website: "www.aputure.com", notes: 'test notes aputure' },
  ],
  patches: [
  ...
  profiles: [
    { fixtureId: 1, channelCount: 5, channels: JSON.stringify({ 1: 'Red', 2: 'Green', 3: 'Blue', 4: 'Intensity', 5: 'Dummy' }), name: 'mode 1' },
    { fixtureId: 1, channelCount: 5, channels: JSON.stringify({ 1: 'Red', 2: 'Green', 3: 'Blue', 4: 'Intensity', 5: 'Dummy', 6: 'Dummy' }), name: 'mode 2' },

    { fixtureId: 2, channelCount: 5, channels: JSON.stringify({ 1: 'Red', 2: 'Green', 3: 'Blue', 4: 'Intensity', 5: 'Dummy'}), name: 'mode 1'},
    { fixtureId: 2, channelCount: 6, channels: JSON.stringify({ 1: 'Red', 2: 'Green', 3: 'Blue', 4: 'Intensity', 5: 'Dummy', 6: 'Dummy' }), name: 'mode 2' },

    { fixtureId: 3, channelCount: 5, channels: JSON.stringify({ 1: 'Red', 2: 'Green', 3: 'Blue', 4: 'Intensity', 5: 'Dummy' }), name: 'mode 1' },
    { fixtureId: 3, channelCount: 6, channels: JSON.stringify({ 1: 'Red', 2: 'Green', 3: 'Blue', 4: 'Intensity', 5: 'Dummy', 6: ' Dummy' }), name: 'mode 2' },

    { fixtureId: 4, channelCount: 5, channels: JSON.stringify({ 1: 'Red', 2: 'Green', 3: 'Blue', 4: 'Intensity', 5: 'Dummy' }), name: 'mode 1'},
    { fixtureId: 4, channelCount: 6, channels: JSON.stringify({ 1: 'Red', 2: 'Green', 3: 'Blue', 4: 'Intensity', 5: 'Dummy', 6: ' Dummy' }), name: 'mode 2' },

    { fixtureId: 5, channelCount: 5, channels: JSON.stringify({ 1: 'Red', 2: 'Green', 3: 'Blue', 4: 'Intensity', 5: 'Dummy' }), name: 'mode 1' },
