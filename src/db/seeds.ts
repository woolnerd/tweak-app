...
export const seeds: Seeds = {
  ...
  patches: [
    ...
    { fixtureId: 1, profileId: 1, startAddress: 6, endAddress: 10, showId: 1 },
    { fixtureId: 2, profileId: 1, startAddress: 11, endAddress: 15, showId: 1 },
    { fixtureId: 2, profileId: 1, startAddress: 16, endAddress: 20, showId: 1 },
    { fixtureId: 2, profileId: 1, startAddress: 21, endAddress: 25, showId: 1 },
  ],
  scenes: [
